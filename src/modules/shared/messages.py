class KeyboardTitles:
    ...
    sort_by_urgency = "⚠️ Сортировка по срочности"
...
class TeacherMessages:
    ...
    SEND_SIZE_REPORT = (
        "📏 Пришлите длину и ширину (в мм) прямоугольника, из которого вырезали деталь. Если вы хотите оставить тот вес, который ввел клиент, то пришлите <b>0</b>\n"
        "<b>Внимание:</b> ответ должен состоять из двух чисел."
    )
    SEND_WEIGHT_REPORT = (
        "⚖️ Пришлите массу готовой детали.Если вы хотите оставить тот вес, который ввел клиент, то пришлите <b>0</b>\n"
